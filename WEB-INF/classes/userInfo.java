...
public class userInfo implements Serializable, userpass {
...
public void getMarks(String[] arg)
{marks=arg;
}
...
public void writeToDB2alt(String pid, String oid)
 ...
 public void fillmarks(String si, String oid)
 {Connection conn;
  Statement stat;
  ResultSet rset;
  ...
  {Class.forName("sun.jdbc.odbc.JdbcOdbcDriver");
   ...
   qry="SELECT OCID FROM O_CERTI_ID WHERE OID='"+oid+"' AND GRADE='"+getgrade()+"'";
   rset=stat.executeQuery(qry);
      
   rset.next();
   
   qry="INSERT INTO TBL"+rset.getString(1)+" VALUES('"+si+"'";
